...
module.exports.failured = function (_message, _data) {
  return base(
...
module.exports.badRequest = function (_message, _data) {
  return base(
...
module.exports.unauthorized = function (_message, _data) {
  return base(
...
module.exports.forbidden = function (_message, _data) {
  return base(
...
module.exports.notFound = function (_message, _data) {
  return base(
...
module.exports.notAllowed = function (_message, _data) {
  return base(
...
module.exports.requestTimeout = function (_message, _data) {
  return base(
...
module.exports.methodNotImplemented = function (_message, _data) {
  return base(
